...
public class Food
{
    public String [][] foodlist ( )
    {
        ...
        System.out.println("You can now order food which will be delivered at your seat");
        ...
        for (int i = 0 ; i<25;)
        {
            ...
            temp = Calc (x);
            temp2 = Calc2 (x);
            if(temp.equals("NO")||temp2.equals("NO")){ continue outer;}else{;}
            Order [0][i] = temp; 
            Order [1][i] = temp2;
            ...
            System.out.println("Enter 1 to exit, 2 to continue ordering");
            x2 = Sc.nextInt();
            if ( x2 == 1){break outer;}
            else{i=i+1;}
            System.out.print("\u000C"); 
    ...
    public static String Calc2(String x)
    {
        ...
        else { System.out.println("Not a valid option, please try again");
            try{
                Thread.sleep(3000);}
