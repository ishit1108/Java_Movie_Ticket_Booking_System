    ...
    public static int Payment ( int Price )
    {
        ...
        while ( true )
        {
            ...
            while(true)
            {
                ...
                int l = x2.length();
                if( (l < 16)||(l>16) ){continue inner;} else {;}
                inner2:
                while(true)
                {
                    System.out.print("\u000C");
                    ...
                    x2 = Sc.nextLine();
                    l = x2.length();
                    if( (l < 4)||(l>4) ){continue inner2;} else {;}
                    System.out.print("\u000C");
                    ...
                    while(true)
                    {
                        ...
                        x2 = Sc.nextLine();
                        l = x2.length();
                        if( (l < 3)||(l>3) ){continue inner3;} else {;}
                        System.out.print("\u000C");
                        ...
                        while(true)
                        {
                            ...
                            x = Sc.nextInt();
                            if(l==x){break outer;}else{continue inner4;}
                        }
                    }
                }
            }
    ...
    public static int Bill2(String seat[][],String food[][],int code,String date,int time,int audi,int Day)
    {
        try {Scanner Sc = new Scanner ( System.in);
            ...
            if(audi==1)
            {
                if(Day==1)
                { for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA1Monday [time][i2].equals("")){
                                s.bookedA1Monday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==2)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA1Tuesday [time][i2].equals("")){
                                s.bookedA1Tuesday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==3)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA1Wednusday [time][i2].equals("")){
                                s.bookedA1Wednusday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==4)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA1Thursday [time][i2].equals("")){
                                s.bookedA1Thursday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==5)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA1Friday [time][i2].equals("")){
                                s.bookedA1Friday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==6)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA1Saturday [time][i2].equals("")){
                                s.bookedA1Saturday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==7)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA1Sunday [time][i2].equals("")){
                                s.bookedA1Sunday [time][i2] = seat [0][j];} else {;}}}}
            }
            else if ( audi == 2)
            {
                if(Day==1)
                { for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA2Monday [time][i2].equals("")){
                                s.bookedA2Monday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==2)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA2Tuesday [time][i2].equals("")){
                                s.bookedA2Tuesday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==3)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA2Wednusday [time][i2].equals("")){
                                s.bookedA2Wednusday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==4)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA2Thursday [time][i2].equals("")){
                                s.bookedA2Thursday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==5)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA2Friday [time][i2].equals("")){
                                s.bookedA2Friday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==6)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA2Saturday [time][i2].equals("")){
                                s.bookedA2Saturday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==7)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA2Sunday [time][i2].equals("")){
                                s.bookedA2Sunday [time][i2] = seat [0][j];} else {;}}}}
            }
            else
            {
                if(Day==1)
                { for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA3Monday [time][i2].equals("")){
                                s.bookedA3Monday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==2)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA3Tuesday [time][i2].equals("")){
                                s.bookedA3Tuesday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==3)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA3Wednusday [time][i2].equals("")){
                                s.bookedA3Wednusday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==4)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA3Thursday [time][i2].equals("")){
                                s.bookedA3Thursday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==5)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA3Friday [time][i2].equals("")){
                                s.bookedA3Friday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==6)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA3Saturday [time][i2].equals("")){
                                s.bookedA3Saturday [time][i2] = seat [0][j];} else {;}}}}
                else if ( Day==7)
                {for(int j = 0; j<=i;++j){
                        for( int i2 = 0;i2<96;++i){
                            if (s.bookedA3Sunday [time][i2].equals("")){
                                s.bookedA3Sunday [time][i2] = seat [0][j];} else {;}}}}
            }
            try {
