...
public class AudiFormat
{
    ...
    public int Audi_G ()
    {
      ...
      s.formatAudi1 [2][2] = "# ";s.formatAudi1 [3][2] = "# ";s.formatAudi1 [4][2] = "# ";
      s.formatAudi1 [5][2] = "# ";
      s.formatAudi1 [6][2]= "# ";s.formatAudi1 [10][3]= "# ";s.formatAudi1 [5][4]= "# ";
      s.formatAudi1 [7][2]= "# ";s.formatAudi1 [11][3]= "# ";s.formatAudi1 [6][4]= "# ";
      s.formatAudi1 [12][2]= "# ";s.formatAudi1 [12][3]= "# ";s.formatAudi1 [7][4]= "# ";
      s.formatAudi1 [13][2]= "# ";s.formatAudi1 [14][3]= "# ";s.formatAudi1 [13][4]= "# ";
      s.formatAudi1 [4][3]= "# ";s.formatAudi1 [15][3]= "# ";s.formatAudi1 [14][4]= "# ";
      s.formatAudi1 [6][3]= "# ";s.formatAudi1 [4][4]= "# ";s.formatAudi1 [15][4]= "# ";
      s.formatAudi1 [7][3]= "# ";
      s.formatAudi1 [3][6]= "# ";s.formatAudi1 [3][7]= "# ";s.formatAudi1 [3][8]= "# ";
      s.formatAudi1 [4][6]= "# ";s.formatAudi1 [6][7]= "# ";s.formatAudi1 [4][8]= "# ";
      s.formatAudi1 [7][6]= "# ";s.formatAudi1 [8][7]= "# ";s.formatAudi1 [6][8]= "# ";
      s.formatAudi1 [8][6]= "# ";s.formatAudi1 [9][7]= "# ";s.formatAudi1 [7][8]= "# ";
      s.formatAudi1 [9][6]= "# ";s.formatAudi1 [10][7]= "# ";s.formatAudi1 [8][8]= "# ";
      s.formatAudi1 [10][6]= "# ";s.formatAudi1 [11][7]= "# ";s.formatAudi1 [9][8]= "# ";
      s.formatAudi1 [13][6]= "# ";s.formatAudi1 [13][7]= "# ";s.formatAudi1 [14][8]= "# ";
      s.formatAudi1 [14][6]= "# ";s.formatAudi1 [14][7]= "# ";s.formatAudi1 [15][8]= "# ";
      s.formatAudi1 [2][9]= "# ";s.formatAudi1 [7][9]= "# ";s.formatAudi1 [13][9]= "# ";
      s.formatAudi1 [3][9]= "# ";s.formatAudi1 [8][9]= "# ";s.formatAudi1 [14][9]= "# ";
      s.formatAudi1 [4][9]= "# ";s.formatAudi1 [9][9]= "# ";
      ...
      s.formatAudi1 [6][0] = "PLATINUM ( 240 /- ) ";
    ...
    public int Audi_3 ()
    {
      ...
      s.formatAudi3 [4][2]="[[#]]";s.formatAudi3 [10][6]="[[#]]";s.formatAudi3 [6][7]="[[#]]";
      s.formatAudi3 [6][2]="[[#]]";s.formatAudi3 [8][6]="[[#]]";s.formatAudi3 [4][7]="[[#]]";
      s.formatAudi3 [8][2]="[[#]]";s.formatAudi3 [6][6]="[[#]]";s.formatAudi3 [2][7]="[[#]]";
      s.formatAudi3 [10][2]="[[#]]";s.formatAudi3 [4][6]="[[#]]";s.formatAudi3 [8][8]="[[#]]";
      s.formatAudi3 [4][4]="[[#]]";s.formatAudi3 [6][4]="[[#]]";s.formatAudi3 [6][8]="[[#]]";
